...
std::shared_ptr<LuaObject> defaults = ( [&]() { auto temp_table_5540 = std::make_shared<LuaObject>();
temp_table_5540->set("x", LuaValue(0.0));
temp_table_5540->set("y", LuaValue(0.0));
temp_table_5540->set("color", "blue");
 return temp_table_5540; } )();
std::shared_ptr<LuaObject> mt = ( [&]() { auto temp_table_4774 = std::make_shared<LuaObject>();
 return temp_table_4774; } )();
...
std::shared_ptr<LuaObject> my_object = ( [&]() { auto temp_table_6289 = std::make_shared<LuaObject>();
 return temp_table_6289; } )();
...
temp_args->set("1", test_string);
return temp_args; } )()));std::cout << std::endl;;
std::shared_ptr<LuaObject> my_table = ( [&]() { auto temp_table_3648 = std::make_shared<LuaObject>();
temp_table_3648->set("1", "a");
temp_table_3648->set("2", "b");
temp_table_3648->set("3", "c");
 return temp_table_3648; } )();
...
temp_args->set("1", ( [&]() { auto temp_table_5135 = std::make_shared<LuaObject>();
 return temp_table_5135; } )());
return temp_args; } )()));std::cout << std::endl;;
...
return temp_args; } )()));std::cout << std::endl;;
std::shared_ptr<LuaObject> my_table_with_mt = ( [&]() { auto temp_table_9523 = std::make_shared<LuaObject>();
 return temp_table_9523; } )();
std::shared_ptr<LuaObject> mt_for_get = ( [&]() { auto temp_table_9162 = std::make_shared<LuaObject>();
temp_table_9162->set("__index", std::make_shared<LuaFunctionWrapper>([=](std::shared_ptr<LuaObject> args) -> LuaValue {
    return "metatable_value";
}));
 return temp_table_9162; } )();
